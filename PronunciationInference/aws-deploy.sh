...
ssh -i /Users/jack/Downloads/mac-key.pem ubuntu@ec2-54-229-5-172.eu-west-1.compute.amazonaws.com 'sudo java -jar ./PronunciationInference/PronunciationInference/PronunciationInference.jar'